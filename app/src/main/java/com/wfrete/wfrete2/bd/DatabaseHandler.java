...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    private final String CREATE_TABLE_MOTORISTAS = "CREATE TABLE MOTORISTAS (ID INTEGER PRIMARY KEY AUTOINCREMENT, NOME TEXT NOT NULL, CPF TEXT, TELEFONE TEXT NOT NULL, S_ID INTEGER, S_DATAHORA DATE)";
    private final String CREATE_TABLE_VEICULOS = "CREATE TABLE VEICULOS (ID INTEGER PRIMARY KEY AUTOINCREMENT, NOME TEXT NOT NULL, MODELO TEXT, PLACA TEXT, ANO INTEGER, S_ID INTEGER, S_DATAHORA DATE)";
    private final String CREATE_TABLE_FRETES = "CREATE TABLE FRETES (ID INTEGER PRIMARY KEY AUTOINCREMENT, " +
                                              ...
                                              "DATA_ABERTURA DATE, DATA_ENCERRAMENTO DATE, MOTORISTA_ID INTEGER, VEICULO_ID INTEGER, CLIENTE TEXT," +
                                                "S_ID INTEGER, S_DATAHORA DATE," +
                                              "FOREIGN KEY(MOTORISTA_ID) REFERENCES MOTORISTAS(ID),FOREIGN KEY(VEICULO_ID) REFERENCES VEICULOS(ID) )";
    private final String CREATE_TABLE_CATEGORIAS = "CREATE TABLE CATEGORIAS (ID INTEGER PRIMARY KEY AUTOINCREMENT, NOME TEXT NOT NULL, TIPO TEXT NOT NULL, S_ID INTEGER, S_DATAHORA DATE)";
